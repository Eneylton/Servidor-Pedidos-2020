...
if($postjson['crud'] == "listar-fabricantes"){
        ...
        $query = mysqli_query($mysqli, "SELECT * FROM fabricante as c ORDER BY c.id desc LIMIT $postjson[start], $postjson[limit]");
    ...
    elseif($postjson['crud'] == "listar-fabri"){
        ...
        $query = mysqli_query($mysqli, "SELECT * FROM fabricante as c ORDER BY c.id ");
